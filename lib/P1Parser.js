...
const AssignNestedValue_1 = require("./Util/AssignNestedValue");
class P1Parser {
    ...
    parseLine(line) {
        ...
        (0, AssignNestedValue_1.AssignNestedValue)(this._packet, mapping.path, this.parseValue(mapping, value));
    }
    /**
